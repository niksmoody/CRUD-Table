...
<?php
    ...
    if(isset($_POST["name"]) && isset($_POST["place"]) && isset($_POST["animal"]) && isset($_POST["thing"])){
        $name = $_POST['name'];
        $place = $_POST['place'];
        $animal = $_POST['animal'];
        $thing = $_POST['thing'];
        $sql = "UPDATE tab SET `name`= '$name', `place`= '$place', `animal`= $animal, `thing`= $thing  WHERE id= ".$_GET["id"];
...
<body>
    <section>
        ...
        <div class="container">
            <?php 
                require_once "conn.php";
                $sql_query = "SELECT * FROM tab WHERE id = ".$_GET["id"];
